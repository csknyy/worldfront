...
for i in range(len(data)):
  ...
  if data["Current Min"][i] == number: list1.append("")
  else: list1.append(max(data["Current Min"][i],number))
...
for i in range(len(data)):
  ...
  if data["Current Max"][i] == number: list1.append("")
  else: list1.append(max(data["Current Max"][i],number))
