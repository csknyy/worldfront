...
data_boxscore0_2.loc['Total'] = ['Total', 'Total', sum(data_boxscore0['Count']), sum(data_boxscore0['Shipped_days']),
...
data_boxscore1_2.loc['Total', :] = ['Total', 'Total', sum(data_boxscore1['Count']), sum(data_boxscore1['Shipped_days']),
