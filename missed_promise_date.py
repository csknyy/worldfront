...
try:
    ...
    data_boxscore0 = data[~(data['Shipped_Date'].isna())][['Date_Purchased', 'Promise_Date', 'Shipped_Date', 'Channel', 'Priced_at_supplier','Supplier']].copy()
    ...
    data_boxscore0['Shipped_days'] = [int(100 * i.total_seconds() / (24 * 60 * 60)) / 100 for i in data_boxscore0['Shipped_days']]

    data_boxscore0['Promised_days'] = data_boxscore0['Promise_Date'] - data_boxscore0['Date_Purchased']
    data_boxscore0['Promised_days'] = [int(100 * i.total_seconds() / (24 * 60 * 60)) / 100 for i in data_boxscore0['Promised_days']]

    data_boxscore0['Promise_Shipped'] = data_boxscore0['Promise_Date'] - data_boxscore0['Shipped_Date']
    data_boxscore0['Promise_Shipped'] = [int(100 * i.total_seconds() / (24 * 60 * 60)) / 100 for i in data_boxscore0['Promise_Shipped']]
    ...
    data_boxscore1_2 = data_boxscore1_2[['Count', 'Avg_Shipped_days', 'Avg_Delivered_days', 'Avg_Promised_days', 'Promise - Delivery']]
    ...
    data_boxscore2_2 = data_boxscore2_2[['Count', 'Avg_Shipped_days', 'Avg_Delivered_days', 'Avg_Promised_days', 'Promise - Delivery']]
