...
try:
    total = total.insert('Total',0)
    total = total.insert('Total',1)
...
data_boxscore['Transport_days'] = data_boxscore['Delivered_days'] - data_boxscore['Shipped_days']
...
data_boxscore_2.loc['Total', :] = [sum(data_boxscore['Count']), sum(data_boxscore['Shipped_days']), sum(data_boxscore['Delivered_days']), sum(data_boxscore['Transport_days']),
                                    sum(data_boxscore['Promised_days']),
...
data_boxscore_2['Avg_Transport_days'] = (data_boxscore_2['Transport_days'] / data_boxscore_2['Count']).round(2)
...
data_boxscore1['Transport_days'] = data_boxscore1['Delivered_days'] - data_boxscore1['Shipped_days']
...
data_boxscore1_2.loc['Total', :] = [sum(data_boxscore1['Count']), sum(data_boxscore1['Shipped_days']),
                                    sum(data_boxscore1['Delivered_days']), sum(data_boxscore1['Transport_days']), sum(data_boxscore1['Promised_days']),
...
data_boxscore1_2['Avg_Transport_days'] = (data_boxscore1_2['Transport_days'] / data_boxscore1_2['Count']).round(2)
...
data_boxscore2['Transport_days'] = data_boxscore2['Delivered_days'] - data_boxscore2['Shipped_days']
...
data_boxscore2_2.loc['Total', :] = [sum(data_boxscore2['Count']), sum(data_boxscore2['Shipped_days']),
                                    sum(data_boxscore2['Delivered_days']), sum(data_boxscore2['Transport_days']), sum(data_boxscore2['Promised_days']),
...
data_boxscore2_2['Avg_Transport_days'] = (data_boxscore2_2['Transport_days'] / data_boxscore2_2['Count']).round(2)
